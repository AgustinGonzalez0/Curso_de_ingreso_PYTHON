...
3.	Para el departamento de logística:
    ...
    transportar. El programa deberá informar la cantidad de camiones, sabiendo que cada uno de ellos puede transportar por viaje 3500kg
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        numero = float(toneladas)

        cuenta = (numero / 3.5) / 1000
        operacion_int = int(cuenta)
